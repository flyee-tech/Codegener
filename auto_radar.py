...
project_path = '/Users/Peiel/radar/src/main/java/'
model_path = project_path + 'com/niuban/radar/automation/model/'
mapper_path = project_path + 'com/niuban/radar/automation/mapper/'
package_base = 'com.niuban.radar.automation.'
...
def main():
    try:
        ...
        for index, row in df.iterrows():
            ...
            table_name, df_desc = getTabelDesc(conn, row['Tables_in_radar'])
